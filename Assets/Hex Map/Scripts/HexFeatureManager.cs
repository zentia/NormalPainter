...
public class HexFeatureManager : MonoBehaviour
{
    ...
    void AddWallSegment(Vector3 nearLeft, Vector3 farLeft, Vector3 nearRight, Vector3 farRight)
    {
        ...
        //towerInstance.transform.localPosition = (farLeft)
    }

    void AddWallSegment(Vector3 pivot, HexCell pivotCell, Vector3 left, HexCell leftCell, Vector3 right,
        HexCell rightCell)
    {
    ...
    public void AddWall(Vector3 c1, HexCell cell1, Vector3 c2, HexCell cell2,
